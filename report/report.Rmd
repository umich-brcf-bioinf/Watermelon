...
# This will be NULL if not set in the snakemake rule (depends on the scenario)
#if(is.null(snakemake@params[['comparisons']]))    include_diffex = FALSE    else    include_diffex = TRUE
