...
# has_comparisons = 'comparisons' %in% names(config)
#
# if(has_comparisons) {
#     comparisons = names(config$comparisons)
# }
#
...
In addition, if you would like more detailed output (e.g. FastQC and/or DESeq2 detailed output, etc.) please let us know. For information on the RNA-seq workflows and a comparison between available differential expression tools, please refer to reference [9].
