...
import scripts.diffex_summarize as diffex_summarize
...
class DiffexSummarizeTest(unittest.TestCase):
    def test_parse_command_line_args(self):
        ...
        args = diffex_summarize._parse_command_line_args(command_line.split())
    ...
    def test_simplify_file_names(self):
        ...
        suffix = '.xlsx'
        actual_names = diffex_summarize._simplify_file_names(file_paths, suffix)
...
0|0|z|0''')
        ...
        annotation_null = '.'
        actual_annotated = diffex_summarize._count_annotated(annotation_column,
                                                             annotation_null,
                                                             df)
...
0|0|.|YES''')
        ...
        actual_pass = diffex_summarize._count_diffex_pass(diffex_call_column,
                                                          diffex_call_pass,
                                                          df)
...
0|0|4|YES''')
        ...
        args = Namespace(annotation_column='gene_id',
                         ...
                         diffex_call_column='call',
                         diffex_call_pass='YES')
        actual_stats = diffex_summarize._get_stats(args, df, name)
...
0|0|4|YES'''.replace('|', '\t')
        ...
        diffex_summarize.main(command_line.split(), log=mock_logger)
