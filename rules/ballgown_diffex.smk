rule ballgown_diffex:
    ...
    output:
        gene_files = expand(BALLGOWN_DIR + '01-ballgown_diffex/{phenotype}/{comparison}_gene.txt',
                        zip,
                        phenotype=ALL_PHENOTYPE_NAMES,
                        comparison=ALL_COMPARISON_GROUPS),
        iso_files = expand(BALLGOWN_DIR + '01-ballgown_diffex/{phenotype}/{comparison}_isoform.txt',
                        zip,
                        phenotype=ALL_PHENOTYPE_NAMES,
                        comparison=ALL_COMPARISON_GROUPS),
