rule ballgown_diffex:
    ...
    output:
        iso_results = DIFFEX_DIR + '{model_name}/ballgown/ballgown_isoform_results.txt',
        rda = DIFFEX_DIR + '{model_name}/ballgown/ballgown_data.rda',
    log:
        DIFFEX_DIR + '{model_name}/ballgown/.log/ballgown_diffex.log'
    conda:
        'envs/diffex.yaml'
    params:
        rsem_dir = ALIGNMENT_DIR + '04-rsem_star_align/',
        snakemake_rdata = DIFFEX_DIR + '{model_name}/ballgown/snakemake.rda' #TWS DEBUG
    script:
