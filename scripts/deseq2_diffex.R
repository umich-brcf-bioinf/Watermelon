...
pdf(file = paste0(plotsDir_comparison,'/PCA.pdf'), onefile = TRUE)
...
pdf(file = paste0(plotsDir_comparison,'/CorrelHeatmap.pdf'), onefile = FALSE)
...
pdf(file = paste0(plotsDir_comparison,'/RLEmatrix.pdf'), onefile = TRUE, compress = TRUE)
