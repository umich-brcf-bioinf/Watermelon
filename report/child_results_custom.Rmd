...
After this, you are ready to use this data in an R-based differential expression package such as DESeq2. For more information on conducting differential gene expression analysis with DESeq2, see [here to get started](https://umich-brcf-bioinf.github.io/rnaseq_demystified_workshop/site/Module8b_DESeq2Initialization), with [additional modules here](https://umich-brcf-bioinf.github.io/rnaseq_demystified_workshop/).
