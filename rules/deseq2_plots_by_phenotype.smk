rule deseq2_plots_by_phenotype:
    ...
    log:
        DIFFEX_DIR + 'plots/by_phenotype/.log/deseq2_plots_by_phenotype.log'
    conda:
        'envs/diffex.yaml'
    params:
        phenotypes = PHENOTYPES,
        diffex_dir = DIFFEX_DIR,
        snakemake_rdata = DIFFEX_DIR + 'plots/by_phenotype/deseq2_plots_by_phenotype_snakemake.rda' #TWS DEBUG
    script:
