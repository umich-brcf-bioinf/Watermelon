rule deseq2_diffex:
    ...
    output:
        iso_results = DIFFEX_DIR + '{factor_name}/DESeq2/{contrast}_isoform.results',
        gene_results = DIFFEX_DIR + '{factor_name}/DESeq2/{contrast}_gene.results',
        rda = DIFFEX_DIR + '{factor_name}/DESeq2/{contrast}.rda'
    threads: 8
    log:
        DIFFEX_DIR + '{factor_name}/DESeq2/.log/{contrast}_deseq2_DESeq2Diffex.log'
    conda:
        'envs/diffex.yaml'
    params:
