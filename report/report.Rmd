...
```{r results, child = 'child_results_qc_align.Rmd', eval = show_results_qc_align}
```

```{r results, child = 'child_results_qc_diffex.Rmd', eval = show_results_qc_diffex}
```
