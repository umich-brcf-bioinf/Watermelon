...
my $gene2RefseqFile = "/ccmb/BioinfCore/Projects/Manjusha/RNA-seq_pipeline/RSQ_scripts/Annotation/${lastUpdate}/NCBI_gene2refseq_" . $lastUpdate;
my $geneInfoFile = "/ccmb/BioinfCore/Projects/Manjusha/RNA-seq_pipeline/RSQ_scripts/Annotation/${lastUpdate}/NCBI_gene_info_" . $lastUpdate;
my $gene2GOFile = "/ccmb/BioinfCore/Projects/Manjusha/RNA-seq_pipeline/RSQ_scripts/Annotation/${lastUpdate}/NCBI_gene2go_" . $lastUpdate;
